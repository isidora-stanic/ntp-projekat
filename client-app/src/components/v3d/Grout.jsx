...
const Grout = ({index, wallSize, size, bumpUrl, roughUrl, imageUrl, color}) => {
  ...
  return (
        <meshStandardMaterial transparent={true} attach={"material-"+index} side={THREE.BackSide} color={color} metalness={0.2} bumpMap={bumpness} roughnessMap={roughness} map={image} />
  )
}
